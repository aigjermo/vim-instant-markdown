vim-instant-markdown (pandoc version)
=====================================


This is a slightly modified version of [this plugin](http://github.com/suan/vim-instant-markdown), which uses [markmon](http://github.com/yyjhao/markmon) instead of [vim-instant-d](http://github.com/suan/instant-markdown-d).

Another small change is that it doesn't open the browser for you, since that might be annoying. Point your browser to `localhost:3000` to see the preview.

At some point I might add support for chosing the port number and custom options for pandoc  etc.

The rest of the readme is from the original plugin, left here for reference.
